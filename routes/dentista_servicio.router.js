...
const DentistaServicioServices = require('../services/dentista_servicio.service');

const router = express.Router();
const service = new DentistaServicioServices();
...
router.patch('/:id', async (req, res) => {
  ...
  const values = {
    p_id_dentista_servicio: req.body.id_dentista_servicio,
    p_operacion: 'UPDATE',
    p_dentista_id: req.body.dentista_id,
    p_servicio_id: req.body.servicio_id
  };
