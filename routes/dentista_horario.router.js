...
const DentistaHorarioServices = require('../services/dentista_horario.service');

const router = express.Router();
const service = new DentistaHorarioServices();
...
router.post('/', async (req, res) => {
  ...
  const values = {
    p_id_dentista_horario: 0,
    p_operacion: 'INSERT',
    p_dentista_id: req.body.p_dentista_id,
    p_horario_id: req.body.p_horario_id
  };
...
router.patch('/:id', async (req, res) => {
  ...
  const values = {
    p_id_dentista_horario: req.body.id_dentista_horario,
    p_operacion: 'UPDATE',
    p_dentista_id: req.body.dentista_id,
    p_horario_id: req.body.horario_id
  };
