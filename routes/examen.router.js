...
const ExamenServices = require('../services/examen.service');

const router = express.Router();
const service = new ExamenServices();
...
router.post('/', async (req, res) => {
  ...
  const values = {
    ...
    p_descripcion: req.body.descripcion,
    p_categoria: req.body.categoria
  };
...
router.patch('/:id', async (req, res) => {
  ...
  const values = {
    p_id_examen: req.body.p_id_examen,
    p_operacion: 'UPDATE',
    p_nombre: req.body.nombre,
    p_descripcion: req.body.descripcion,
    p_categoria: req.body.categoria
