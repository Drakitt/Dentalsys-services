...
const EvaluacionServices = require('../services/evaluacion.service');

const router = express.Router();
const service = new EvaluacionServices();
...
router.post('/', async (req, res) => {
  ...
  const values = {
    ...
    p_examen_id: req.body.examen_id,
...
router.patch('/:id', async (req, res) => {
  ...
  const values = {
    p_id_evaluacion: req.body.id_evaluacion,
    p_operacion: 'UPDATE',
    p_nombre: req.body.nombre,
    p_examen_id: req.body.examen_id,
    p_tipo: req.body.tipo
