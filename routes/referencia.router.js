...
const ReferenciaServices = require('../services/referencia.service');

const router = express.Router();
const service = new ReferenciaServices();
...
router.patch('/:id', async (req, res) => {
  ...
  const values = {
    p_id_referencia: req.body.p_id_referencia,
    p_operacion: 'UPDATE',
    p_fecha: req.body.fecha,
    p_motivo: req.body.motivo,
    p_tipo: req.body.tipo,
